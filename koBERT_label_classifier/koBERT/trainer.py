...
def train(config):
    ...
    train_dataset = koBERTDataset(train_data, 0, 1, tok, vocab, config.max_len, True, False)
    valid_dataset = koBERTDataset(valid_data, 0, 1, tok, vocab, config.max_len, True, False)
